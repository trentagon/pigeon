...
in.file_description = "This is an input file for PIGEON that is configured to figure 2-steady state of Hu and Thomas 2022.";

%Start and end time
in.t_start   = 700; % [Myr] 700 Myr = 3.8 Ga (time starts at 4.5 Ga)
in.t_end     = 4500; % [Myr] 4500 Myr = 0 Ga = Today

in.pn0  = 300; % Initial pressure of N2[mbar]
...
in.f_photoN = 6.5; %Photochemical multiplier
in.f_sputtering = 3.5; %Sputtering multiplier
in.f_outgassing = 6.5; %Outgassing multiplier
